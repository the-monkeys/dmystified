...
const PricingCard = ({
	...
	return (
		<div className="group w-96 flex flex-col border-1 border-slate-200 rounded-lg overflow-hidden hover:border-slate-400">
			<div className="px-4 pt-4 pb-2 border-b-1 border-slate-200">
